...
@Component({
	templateUrl: './cooking.trait.component.html',
})
export class CookingTrait extends TraitBase implements TraitInterface {
    static traitName = "cooking"

	override traitForm = new FormGroup({
		type: new FormControl(CookingTrait.traitName),
		cost: new FormGroup({
